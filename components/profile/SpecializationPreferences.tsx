...
interface SpecializationPreferencesProps {
  onSubmit: (data: SpecializationFormValues) => void
}

export default function SpecializationPreferences({ onSubmit }: SpecializationPreferencesProps) {
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <div className="space-y-4">
            <h3 className="text-lg font-medium">Specializations & Expertise</h3>
