    ...
    <Card className="border shadow-sm">
      <CardContent>
        <div className="mb-4">
          ...
          <p className="text-muted-foreground">Showcase of professional achievements and success stories</p>
        </div>
        {portfolioItems.length === 0 ? (
          <div className="py-10 flex flex-col items-center justify-center text-center">
            <Building2 className="h-12 w-12 text-muted-foreground mb-4" />
            <h3 className="text-lg font-medium">No portfolio items found</h3>
            <p className="text-muted-foreground mt-1 mb-4">This coach has not added any portfolio items yet.</p>
          </div>
        ) : (
          <div className="flex gap-6 overflow-x-auto pb-2 -mx-2 px-2">
            {portfolioItems.map((item) => (
              <div
                key={item.ulid}
                className="relative rounded-xl bg-white shadow-md hover:shadow-lg transition-all overflow-hidden group border min-w-[315px] md:min-w-[405px] max-w-[405px] h-[340px] flex flex-col"
                tabIndex={0}
