...
const IGNORED_DIRS = ['dashboard', 'api', 'node_modules', '.next'];
...
console.log('Adding dynamic exports to app pages...');
walkDirectory(APP_DIR)
  .then(() => console.log('✅ All app pages processed successfully!'))
