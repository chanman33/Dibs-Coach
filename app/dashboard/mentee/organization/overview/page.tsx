...
import { Building2, Award, Users, BookOpen, CreditCard, Clock, FileText, Video, ArrowRight } from "lucide-react"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card>
              ...
              <CardContent>
                ...
                <Progress className="mt-2" value={(overviewData.credits.available / overviewData.credits.total) * 100} />
